  ...
  return (
    <div className='Numbers'>
     ...
     <div className='Mainnumbers'>
      ...
      <CountUp className='Number1numbers' end={700} duration={5} />
      ...
      <CountUp className='Number1numbers' end={1000} duration={7} />
